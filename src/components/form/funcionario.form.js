...
import SelectCustom from '../custom-select';
 ...
 const FormCustomFuncionario = ({id,initialData,handleSubmit,options})=>{
     return(
         <div style={{marginTop:80,marginLeft:20}}>
             <Form id={id}  initialData={initialData} onSubmit={handleSubmit}>
                ...
                {
                    (options.length  > 0)?(
                        <SelectCustom required isSearchable  name={'servico_id'} placeholder={'Selecione um Serviço'} options={options}    />
                    ):null
                }
 ...
 export default FormCustomFuncionario;